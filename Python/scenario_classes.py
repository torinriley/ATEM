...
class Task:
    def __init__(self, task_name, points, time_required):
        """
...
class Scenario:
    ...
    def get_tasks(self):
        ...
        """
        return [{"task_name": task.task_name, "points": task.points, "time_required": task.time_required} for task in self.tasks]
